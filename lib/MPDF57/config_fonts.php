...
$this->backupSubsFont = array('dejavusanscondensed');
    ...
    $this->backupSubsFont = array('arialmt');
...
$this->fontdata = array(
    ...
    "helvetica" => array(
        'R' => "helvetica.ttf",
        'B' => "Helvetica-Bold.ttf",
        'I' => "Helvetica-Bold.ttf",
        'BI' => "Helvetica-Bold.ttf",
    ),
...
/* Thai fonts */
    ...
    "arialmt" => array(
        'R' => "arialmt.ttf",
        'B' => "Helvetica_Bold.ttf",
        'I' => "arialmt.ttf",
        'BI' => "Helvetica_Bold.ttf",
    ),
